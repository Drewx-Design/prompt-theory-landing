...
import { waitlistApi, validateEmail, getErrorMessage } from '@/lib/services/waitlist';
...
const LandingPageClient = () => {
  ...
  const [timeLeft, setTimeLeft] = useState<TimeLeft>({ days: 7, hours: 0, minutes: 0 });
  const [modalImage, setModalImage] = useState<ModalImage | null>(null);
  const [waitlistStatus, setWaitlistStatus] = useState<WaitlistStatus>('idle');
  const [waitlistMessage, setWaitlistMessage] = useState('');
  const [proWaitlistStatus, setProWaitlistStatus] = useState<WaitlistStatus>('idle');
  const [proWaitlistMessage, setProWaitlistMessage] = useState('');
  const [teamWaitlistStatus, setTeamWaitlistStatus] = useState<WaitlistStatus>('idle');
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <Link href="/privacy" className="text-[#6B7280] hover:text-[#1A1A1A]">Privacy Policy</Link>
