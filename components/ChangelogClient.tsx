...
import { ChevronLeft, Calendar, Zap } from 'lucide-react';
      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm shadow-[0_1px_3px_rgba(0,0,0,0.08)] border-b border-[#F5F5F5] z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link
              href="/"
              className="text-[#6B7280] hover:text-[#1A1A1A] transition flex items-center"
            >
      ...
      <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <Zap className="text-[#0066FF] mx-auto mb-4" size={48} />
          ...
          <div className="space-y-12">
            {changelogEntries.map((entry, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.06)] border border-[#E5E5E5] hover:shadow-[0_4px_6px_rgba(0,0,0,0.07),0_2px_4px_rgba(0,0,0,0.05)] transition-shadow duration-200"
              >
                {/* Version Header */}
                  ...
                  {entry.items.map((item, itemIndex) => (
                    <li key={itemIndex} className="flex items-start">
                      ...
                      <div className="flex-1">
                        <span className="inline-block px-2 py-0.5 text-xs font-semibold rounded bg-[#F0F7FF] text-[#0066FF] mr-2">
          ...
          {/* Footer */}
          <div className="text-center pt-12 border-t border-[#E5E5E5] mt-12">
            ...
            <p className="text-[#6B7280] italic mb-6 max-w-2xl mx-auto">
            ...
            <Link
              href="/"
              className="inline-block text-[#0066FF] hover:text-[#0052CC] transition font-semibold"
            >
              Return to Homepage
            </Link>
          </div>
